...
def run(fname_stat, outname_stat, write_report = False):
    ...
    rate_unc_tt    = math.log(1.2)
    rate_unc_tW    = math.log(1.2)
    rate_unc_QCD   = math.log(2.0)
    rate_unc_other = math.log(1.5)

    #model_stat.add_lognormal_uncertainty('SingleTop_stch_rate', rate_unc_other , procname='SingleTop_stch',obsname='*')
    #model_stat.add_lognormal_uncertainty('WJets_rate', rate_unc_other , procname='WJets',obsname='*')
    #model_stat.add_lognormal_uncertainty('DYJets_rate', rate_unc_other , procname='DYJets',obsname='*')
