...
def run(fname_stat, outname_stat, write_report = False):
    ...
    model_stat.add_lognormal_uncertainty('TTbar_rate',           math.log(1.2) , procname='TTbar',obsname='*') # 1.056 wie bei Alex' Masterarbeit

    model_stat.add_lognormal_uncertainty('SingleTop_stch_rate', rate_unc_st , procname='SingleTop_stch',obsname='*')
