...
int TMVAClassification_2b( TString myMethodList = "" )
{
   ...
   */
   ...
   for( int i = 0; i < input.size(); ++i )
     {
       std::cout << "--- TMVAClassification_2b       : Using input file: " << input.at(i)->GetName() << std::endl;
     }
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification_2b(methodList); 
}
